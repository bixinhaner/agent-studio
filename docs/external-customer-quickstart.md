...
![External customer sign-in](./assets/external-customer-quickstart/01-external-sign-in.png)
...
![Trial access application form](./assets/external-customer-quickstart/02-trial-application-form.png)
...
![Public request status page](./assets/external-customer-quickstart/03-request-status.png)
...
![Access ready email](./assets/external-customer-quickstart/email-02-access-ready.png)
...
![Invite sign-in page](./assets/external-customer-quickstart/04-invite-sign-in.png)

### 6. Enter the verification code

Check your mailbox for the verification email, enter the code, and select `Verify & Sign In`.

![Verification step](./assets/external-customer-quickstart/05-verification-code-step.png)

![Verification code email](./assets/external-customer-quickstart/email-03-verification-code.png)
...
![Request received email](./assets/external-customer-quickstart/email-01-request-received.png)
