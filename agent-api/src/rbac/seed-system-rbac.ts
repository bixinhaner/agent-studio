...
export const BUILTIN_PERMISSION_DEFINITIONS: PermissionDefinition[] = [
  ...
  { key: "system_settings.read", name: "Read system settings", category: "system_settings" },
  { key: "system_settings.write", name: "Edit system settings draft", category: "system_settings" },
  { key: "system_settings.publish", name: "Publish system settings", category: "system_settings" },
