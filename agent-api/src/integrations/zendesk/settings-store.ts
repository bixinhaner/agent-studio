...
export class ZendeskSettingsStore {
  ...
  private normalize(input: ZendeskIntegrationSettings): ZendeskIntegrationSettings {
    ...
    return {
      ...
      dingtalkReviewCcRoutingEnabled: Boolean(input.dingtalkReviewCcRoutingEnabled),
      dingtalkReviewAssigneeRoutingEnabled: input.dingtalkReviewAssigneeRoutingEnabled !== false,
      dingtalkReviewGroupFallbackEnabled: input.dingtalkReviewGroupFallbackEnabled !== false,
      dingtalkReviewGlobalFallbackEnabled: input.dingtalkReviewGlobalFallbackEnabled !== false,
      dingtalkReviewAllowedReviewerEmails: normalizeEmailList(input.dingtalkReviewAllowedReviewerEmails),
      dingtalkReviewReconcileOnUpdateEnabled: input.dingtalkReviewReconcileOnUpdateEnabled !== false,
