  ...
  router.put("/settings", async (req: Request, res: Response) => {
    try {
      ...
      const patch = {
        ...
        dingtalkReviewCcRoutingEnabled: input.dingtalk_review_cc_routing_enabled,
        dingtalkReviewAssigneeRoutingEnabled: input.dingtalk_review_assignee_routing_enabled,
