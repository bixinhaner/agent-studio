...
describe("AdminNav", () => {
  it("switches sections through button clicks", () => {
    ...
    expect(onChange).toHaveBeenNthCalledWith(3, "capabilities");
    expect(onChange).toHaveBeenNthCalledWith(4, "organization");
    expect(onChange).toHaveBeenNthCalledWith(5, "monitoring");
  });
});
